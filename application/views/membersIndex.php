...
义工&nbsp;<font><?php echo $name; ?></font>&nbsp;统计中心
</h3>
...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
	...
	<tr>
		<td width="20%" align="right">已经捐赠金额：&nbsp;</td>
		<td width="20%" align="left"><?php echo number_format($totalMoneyPay,2);?></td>
	</tr>
	<tr>
		<td width="20%" align="right">未到捐赠金额：&nbsp;</td>
		<td width="20%" align="left"><?php echo number_format(($totalMoney-$totalMoneyPay),2);?></td>
	</tr>
	<tr>
		<td width="20%" align="right"><a href="<?php echo URL_APP_C;?>/Members/userList">查看登记功德主列</a>&nbsp;&nbsp;</td>
		<td width="20%" align="left">&nbsp;&nbsp;<a href="<?php echo URL_APP_C;?>/Members/orderList">查看捐赠列表</a>
		&nbsp;&nbsp;

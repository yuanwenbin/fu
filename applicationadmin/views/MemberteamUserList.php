...
业务员&nbsp;<font><?php echo $memberInfos['member_username']; ?></font>&nbsp;登记功德主列
</h3>
...
?>
	<a href="<?php echo URL_APP_C;?>/Memberteam/MemberteamUserList?id=<?php echo $id; ?>&page=<?php echo $i; ?>"><?php echo $i; ?></a>&nbsp;		
<?php } }
	$toPage = $page + 5;
...
<?php }else {?>
<a href="<?php echo URL_APP_C;?>/Memberteam/MemberteamUserList?id=<?php echo $id; ?>&page=<?php echo $ii; ?>"><?php echo $ii; ?></a>&nbsp;
<?php } 
	 }
 ?>
</p>

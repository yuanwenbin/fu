...
class Room_model extends CI_Model
{
	 ...
	 */
	function posLocationDeal($localtion_id,$location_price,$location_type,$location_alias,$location_details,$filePic,$location_number,$location_ispayment,$location_paytime)
	{
